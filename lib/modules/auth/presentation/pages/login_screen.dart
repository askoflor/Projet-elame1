...
class _LoginScreenState extends State<LoginScreen> {
  ...
  void _handleDemoMode(AuthProvider auth) {
    ...
    auth.enableDemoMode(
      ...
      role: _demoIsProvider ? 'PRESTATAIRE' : 'CLIENT',
    );
  }

  Widget _buildDemoRoleOption(String label, bool isProvider) {
    final selected = _demoIsProvider == isProvider;
    return HoverWrap(
      child: GestureDetector(
      onTap: () => setState(() => _demoIsProvider = isProvider),
                ...
                decoration: BoxDecoration(
                  ...
                  gradient: RadialGradient(
                    colors: [
                      ...
                      const Color(0xFF34A853).withOpacity(0),
                    ],
                  ),
                ),
              ),
                        ...
                        if (auth.isConnectionError) ...[
                          ...
                          Container(
                            ...
                            child: Row(
                              children: [
                                Expanded(
                                  child: _buildDemoRoleOption(context.tr('auth.roleClient'), false),
                                ),
                                const SizedBox(width: 4),
                                Expanded(
                                  child: _buildDemoRoleOption(context.tr('auth.rolePrestataire'), true),
                                ),
                              ],
                            ),
                          ),
                          const SizedBox(height: 10),
                            ...
                            child: ScaleOnHover(
                              ...
                              child: PointerCursor(child: OutlinedButton.icon(
                                ...
                                label: Text(context.tr('auth.modeDemo'), style: const TextStyle(fontWeight: FontWeight.w600)),
                              )),
                            ),
                          ),
                        ],
